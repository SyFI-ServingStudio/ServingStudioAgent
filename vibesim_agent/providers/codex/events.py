...
CODEX_TRANSPORT_FAILURE_STATUSES = {
...
def _find_rollout_file(home: Path, session_id: str) -> Path | None:
            ...
            for raw_line in file:
                try:
                    ...
                    if not raw_line.endswith(b"\n"):
                        # Retry an unfinished record; complete EOF JSON is valid.
                        file.seek(-len(raw_line), 1)
                        break
                    continue
