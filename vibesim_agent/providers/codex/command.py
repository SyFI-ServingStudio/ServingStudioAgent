...
from ...runtime.permissions import validated
...
class CodexCommand:
    ...
    def arguments(self, request: AgentRequest, *, home: str) -> list[str]:
        ...
        permissions = validated(request.execution.permissions)
        posture = {
            "default_permissions": permissions.profile,
            "approval_policy": permissions.approval_policy,
        }
        if permissions.reviewer is not None:
            posture["approvals_reviewer"] = permissions.reviewer
