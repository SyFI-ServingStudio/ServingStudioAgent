...
claude_package="${CLAUDE_NPM_PACKAGE:-@anthropic-ai/claude-code@2.1.250}"
...
runner_version="${CODEX_RUNNER_IMAGE_VERSION:-prebuilt-agent-runner-v11}"
...
docker build \
  ...
  --build-arg "CLAUDE_NPM_PACKAGE=$claude_package" \
