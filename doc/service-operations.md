...
[Named Provider Connections](providers.md) and [example YAML](../examples/providers.yaml).
...
See [managed startup configuration](migration-v1.md#managed-startup-entry).
...
See [migration and managed startup](migration-v1.md) for configuration,
verification and recovery, and [deployment cutover](cutover.md) for the
